                ...
                <div className='information-fullscreen-wrapper'>
                    <div className='information-fullscreen'>
                        ...
                        <div className='information-fullscreen-content'>
                            ...
                            so please bare this in mind with your creative decisions and designs for the artwork. Please note, the colour background will be used in the fullscreen player and miniplayer!</p>
                        </div>
                    </div>
